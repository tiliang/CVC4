...
#ifndef __CVC4__REWRITE_PRIORITY_H
#define __CVC4__REWRITE_PRIORITY_H
...
struct RewritePriorityHashFunction {
  size_t operator()(const ::CVC4::RewritePriority& p) const {
    return __gnu_cxx::hash<int>()(p.getPriority());
  }
};/* struct RewritePriorityHashFunction */
...
#endif /* __CVC4__REWRITE_PRIORITY_H */
